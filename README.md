...
|:----:|--------------|--------|
| 1.1 |Service Principal Handling via Metadata, plus: <ul><li>Data Factory table.</li><li>Properties table and view.</li><li>Function body bug fix.</li><li>New sample data.</li></ul> | |
