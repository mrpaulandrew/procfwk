...
|:----:|--------------|--------|
| 1.5 |<u>Power BI Dashboard for Framework Executions</u>, plus:<ul><li>Pipeline Run ID now logged.</li></ul> |[ADF.procfwk v1.5 - Power BI Dashboard for Framework Executions](https://mrpaulandrew.com) |
